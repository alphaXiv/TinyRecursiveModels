...
![Sudoku-Extreme TRM-Attention Claim vs Achieved](reports/plots/image.png){width=600px}
...
![Sudoku-Extreme TRM-MLP Claim vs Achieved](reports/plots/claims_vs_achieved_trm-mlp-variant.png){width=600px}
<!-- 
